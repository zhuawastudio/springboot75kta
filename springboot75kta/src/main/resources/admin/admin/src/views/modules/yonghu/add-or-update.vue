<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="qq号" prop="qqhao">
          <el-input v-model="ruleForm.qqhao" 
              placeholder="qq号" clearable  :readonly="ro.qqhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="qq号" prop="qqhao">
              <el-input v-model="ruleForm.qqhao" 
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      if((this.ruleForm.yonghuzhanghao.length<12)){
